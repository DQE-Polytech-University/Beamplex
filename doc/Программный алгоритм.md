...
<table> 
  <tr>
    <td width="200">Загрузка данных в буфер. Диагностика состояния системы и сообщения обо всех возникших ошибках</td><td><listing>def loadJSON( self ):
	        try:
  ...
  <tr>
    <td width="200">Извлечение и чтение информации из входного файла, выявление ошибок в файле (отсутствие входных данных, некорректные данные: количество слоев, границы значений)</td><td><listing>def parseJSONData(self):      
	        try:
	            self.concentration = []
	            self.thickness = []
